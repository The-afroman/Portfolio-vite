    ...
    return (
      <div className="App">
        ...
        <div className='Cards'>
          ...
          <div className='col'>
            <Card name="WebGL 3D viewer" description="WebGL 3D viewing program, uses custom written glsl shaders for phong and gouraud lighting models with bump mapping for normals. Ability to interactively change lighting position color and diffuse and specular attributes of individual point or directional lights. Custom scene graph data structure to represent the scene. Final project for computer graphics class." imgsrc={process.env.PUBLIC_URL+"/webgl.png"} link="https://github.com/The-afroman/computer-graphics-3D-viewer" />

            <Card name="Personal Site" description="portfolio showcase (this site) created with react, express, node, typescript" imgsrc={process.env.PUBLIC_URL + "/portfolio.png"} link="https://github.com/The-afroman/Portfolio" />
